    ...
    <div class="container mx-auto px-4 sm:px-6 lg:px-8">
        <div class="flex justify-between items-center h-16 sm:h-20">
            ...
            <div class="hidden lg:flex items-center space-x-1 xl:space-x-2">
                ...
                <a href="../index.php#features" class="nav-link group px-4 py-2 rounded-lg text-gray-700 hover:text-purple-600 font-medium transition-all duration-300 relative">
                    <span class="relative z-10">Features</span>
                    <div class="absolute inset-0 bg-purple-50 rounded-lg opacity-0 group-hover:opacity-100 transition-opacity duration-300"></div>
                </a>
                <a href="../index.php#testimonials" class="nav-link group px-4 py-2 rounded-lg text-gray-700 hover:text-purple-600 font-medium transition-all duration-300 relative">
    ...
    <div id="mobile-menu">
        ...
        <div class="p-4 sm:p-6">
            ...
            <div class="space-y-2 mb-6">
                ...
                <a href="../index.php#features" class="flex items-center space-x-3 p-3 sm:p-4 rounded-xl text-gray-700 hover:bg-purple-50 hover:text-purple-600 transition-all duration-300 group">
                    <i class="ri-star-line text-xl group-hover:scale-110 transition-transform duration-300"></i>
                    <span class="font-medium">Features</span>
                </a>
                <a href="../index.php#testimonials" class="flex items-center space-x-3 p-3 sm:p-4 rounded-xl text-gray-700 hover:bg-purple-50 hover:text-purple-600 transition-all duration-300 group">
